...
//==================================================================================================
void makePlotsFake(bool isBlind=0, bool drawSignal=0)
{
  ...
  //TString thisCut = "*(phoEt > 160 && metCor > 140 && phoMetDeltaPhi > 0.5 && phoIsFake > 0.5 && (nalljets == 0 || (nalljets == 1 && jetMetDeltaPhi > 0.5 && jetMetDeltaPhi < 2.65 && phoJetDeltaPhi < 2.9)))";
  TString thisCut = "*(phoEt > 160 && metCor < 30 && nalljets < 2 && (phoIsFake == 1 || phoIsFake == 3))";
  ...
  //makeStack("nphotons", thisCut, "nphotons", "nphotons", "", 
               ...
               //1, -1, 10,
               //0);
  //// sigma ietaieta: fixed binning
  //makeStack("phoCoviEtaiEta", thisCut, "phoCoviEtaiEta", "#sigmai_{#etai#eta}", "", 
               //listOfSignals, listOfSamples, listOfDatasets, 
               //inFileName,
               ...
               //0);
  //// sigma ietaieta: fixed binning
  //makeStack("phoR9", thisCut, "phoR9", "#gamma R9", "", 
               //listOfSignals, listOfSamples, listOfDatasets, 
               //inFileName,
               //isBlind, false, drawSignal, false,
               //20, 0.024, 1.1,
  ...
  //makeStack("metCor", thisCut, "met", "CaloMET [GeV]", "GeV", 
               //listOfSignals, listOfSamples, listOfDatasets, 
               //inFileName,
               ...
               float* xlowVec)
{
  ...
  can->cd();
  can->Modified();
  can -> SaveAs(myName + "_fake.pdf","pdf");
  can -> SaveAs(myName + "_fake.png","png");
