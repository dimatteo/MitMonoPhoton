...
void makeSyncTables()
{
  ...
  cout << fixed << setprecision(3) << "photon[0] Et > 160  | " << (int)counts[3] << " | " << counts[3]/counts[0] * 100. << "%" << endl; 
  cout << fixed << setprecision(3) << "met > 140           | " << (int)counts[4] << " | " << counts[4]/counts[0] * 100. << "%" << endl; 
  cout << fixed << setprecision(3) << "photon[0] is good   | " << (int)counts[5] << " | " << counts[5]/counts[0] * 100. << "%" << endl; 
